...
export const FLOATING_ITEMS: FloatingItemConfig[] = [
  ...
  { id: "f3", src: "/番茄们 浮动元素3.png", width: 375, x: -RADIUS * 0.55, y: Y_SPAN * 0.85, z: 0, rot: -4, priority: true },
  ...
  { id: "f6", src: "/番茄们 浮动元素6.png", width: 345, x: RADIUS * 0.15, y: -Y_SPAN * 1.0, z: 0, rot: -10, priority: true },
]
