      ...
      <div className="feature-grid feature-grid-2">
        <div className="feature-card">
          ...
          <h3 className="feature-name">
            工作室主理人
            <span className="bilingual-en">Studio Manager</span>
          </h3>
          <p className="feature-desc">
            艺术硕士毕业，曾担任知名设计公司团队负责人，拥有7年设计实战经验，专注插画领域多年，擅长插画艺术与商业设计结合，做有温度的设计。
            <span className="bilingual-en">
        ...
        <div className="feature-card">
          ...
          <h3 className="feature-name">
            设计合伙人
            <span className="bilingual-en">Design Partner</span>
          </h3>
          <p className="feature-desc">
            曾担任上市公司团队负责人，在消费科技领域深耕，擅长塑造品牌的温度感，将理性产品逻辑转化为感性品牌语言的能力。
            <span className="bilingual-en">
